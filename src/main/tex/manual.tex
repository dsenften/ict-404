...
\inputminted[frame=single,autogobble,linenos,firstline=7,lastline=11]{java}
...
Bis \emph{dato} konnten wir einige Aspekte festhalten, die uns die Vererbung
bringt:
